...
{
	const RwReal nearScreenZ = *(RwReal*)(g_libGTASA + 0x009DAA60); // CSprite2d::NearScreenZ 0x009DAA60
	const RwReal recipNearClip = *(RwReal*)(g_libGTASA + 0x009DAA64); // CSprite2d::RecipNearClip 0x009DAA64
