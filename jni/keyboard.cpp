...
void CKeyBoard::Render()
{
	...
	// input string
	if(pDialogWindow->m_byteInputState != 2)
	{
		...
		if(strlen(m_utf8Input) == 0) szStr = "";
		if(strlen(m_utf8Input) == 1) szStr = "*";
		if(strlen(m_utf8Input) == 2) szStr = "**";
		if(strlen(m_utf8Input) == 3) szStr = "***";
		if(strlen(m_utf8Input) == 4) szStr = "****";
		if(strlen(m_utf8Input) == 5) szStr = "*****";
		if(strlen(m_utf8Input) == 6) szStr = "******";
		if(strlen(m_utf8Input) == 7) szStr = "*******";
		if(strlen(m_utf8Input) == 8) szStr = "********";
		if(strlen(m_utf8Input) == 9) szStr = "*********";
		if(strlen(m_utf8Input) == 10) szStr = "**********";
		if(strlen(m_utf8Input) == 11) szStr = "***********";
		if(strlen(m_utf8Input) == 12) szStr = "************";
		if(strlen(m_utf8Input) == 13) szStr = "*************";
		if(strlen(m_utf8Input) == 14) szStr = "**************";
		if(strlen(m_utf8Input) == 15) szStr = "***************";
		if(strlen(m_utf8Input) == 16) szStr = "****************";
		if(strlen(m_utf8Input) == 17) szStr = "*****************";
		if(strlen(m_utf8Input) == 18) szStr = "******************";
		if(strlen(m_utf8Input) == 19) szStr = "*******************";
		if(strlen(m_utf8Input) == 20) szStr = "********************";
		if(strlen(m_utf8Input) == 21) szStr = "*********************";
		if(strlen(m_utf8Input) == 22) szStr = "**********************";
		if(strlen(m_utf8Input) == 23) szStr = "***********************";
		if(strlen(m_utf8Input) == 24) szStr = "************************";
		if(strlen(m_utf8Input) == 25) szStr = "*************************";
		if(strlen(m_utf8Input) == 26) szStr = "**************************";
		if(strlen(m_utf8Input) == 27) szStr = "***************************";
		if(strlen(m_utf8Input) == 28) szStr = "****************************";
		if(strlen(m_utf8Input) == 29) szStr = "*****************************";
		if(strlen(m_utf8Input) == 30) szStr = "******************************";
		if(strlen(m_utf8Input) == 31) szStr = "*******************************";
		if(strlen(m_utf8Input) >= 32) szStr = "********************************";

		strcpy(m_utf8Input2, szStr);
		cp1251_to_utf8(m_utf8Input2, szStr);
		ImGui::GetForegroundDrawList()->AddText(pGUI->GetFont(), m_fFontSize, 
			ImVec2(m_Pos.x + m_Size.x * 0.02, m_Pos.y + m_Pos.y * 0.05), 0xFFFFFFFF, m_utf8Input2);
	}
	...
	for(int i=0; i<LAYOUT_ROWS_C; i++)
	{
		...
		//for( auto key : m_Rows[m_iLayout][i])
		{
			...
			if(key.id == m_iPushedKey && key.type != KEY_SPACE && 
				(pDialogWindow->m_byteInputState != 2 && pChatWindow->m_byteRepeatKeys == 1)) {
				ImGui::GetForegroundDrawList()->AddRectFilled(
					key.pos,
...
void CKeyBoard::Send()
{
	...
	if (trim(m_sInput).length() > 0) {
		if(pDialogWindow && pChatWindow) {
			if(pDialogWindow->m_byteInputState != 1 && pDialogWindow->m_byteInputState != 2 && pChatWindow->m_byteRepeatKeys == 1) {
				m_sInputLast = m_sInput;
			}
		}
		if(m_RepeatKey.active != 1) {
			m_RepeatKey.active = 1;
		}
	}
	
	if(pDialogWindow) {
		if(pDialogWindow->GetState()) {
			if(pDialogWindow->m_byteInputState == 2) {
				pDialogWindow->SetPasswordText(m_utf8Input2);
			}
		}
	}
	m_bEnable = false;
