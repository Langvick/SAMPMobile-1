...
enum
{
	...
	ID_DISCONNECTION_NOTIFICATION = 32, //SAMPSRV
	...
	ID_RECEIVED_STATIC_DATA = 41, //SAMPSRV
	...
	ID_REMOTE_DISCONNECTION_NOTIFICATION = 42, //SAMPSRV
	...
	ID_REMOTE_CONNECTION_LOST = 43, //SAMPSRV
	...
	ID_REMOTE_NEW_INCOMING_CONNECTION = 44, //SAMPSRV
	...
	ID_REMOTE_EXISTING_CONNECTION = 45, //SAMPSRV

	/// [CLIENT] - 33: Got the data for another client
	ID_REMOTE_STATIC_DATA = 46, //SAMPSRV
	...
	ID_ADVERTISE_SYSTEM = 55, //SAMPSRV
